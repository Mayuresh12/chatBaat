...
String username,tempName,gender,age,mobile;
            ...
            throws ServletException, IOException 
    {
        ...
        try (PrintWriter out = response.getWriter()) 
        {
         ...
         String gender= session.getAttribute("gender").toString(); //Extract gender
         String age=session.getAttribute("age").toString() ;//Extract age
         String mobile=session.getAttribute("mobile").toString() ;//Extract age
        ...
        if(request.getParameter("txtMsg")!=null)
         {
           ...
           try
           {
                ...
                java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hello_chat","root","root");
              
                Statement st=con.createStatement();
             
                
                String sql = "insert into hello_message values ('"+username+"','"+message+"','"+gender+"','"+age+"','"+mobile+"')";
