...
public String username,gender,age,mobile;
            ...
            throws ServletException, IOException 
    {
        ...
        gender=request.getParameter("genderValue"); //Extract gender
         age=request.getParameter("ageValue"); //Extract age
         mobile=request.getParameter("mobileValue"); //Extract age
        ...
        try
        {
           ...
           session.setAttribute("gender",request.getParameter("genderValue")); //Set Attribute
           String gender = session.getAttribute("gender").toString(); //Extract Username
       
           session.setAttribute("age",request.getParameter("ageValue")); //Set Attribute
           String age = session.getAttribute("age").toString(); //Extract Username
           
           
           session.setAttribute("mobile",request.getParameter("mobileValue")); //Set Attribute
           String mobile = session.getAttribute("mobile").toString(); //Extract Username
...
"}\n" +
"</style><body bgcolor=\"#FEFEFE\"> <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"> <title>Chat Room</title>  </head>");
